...
train_x_orig_G, train_y_G,test_x_orig, test_y,classes= load_data('./train/Gaussian_pic/')
...
train_x_orig =train_x_orig+train_x_orig_G#+train_x_orig_45+train_x_orig_90+train_x_orig_135
...
parameters = L_layer_model(train_x, train_y, layers_dims, num_iterations = 1900, print_cost = True)
